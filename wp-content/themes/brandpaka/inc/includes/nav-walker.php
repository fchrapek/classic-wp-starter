 ...
 */
class Nav_Walker extends \Walker_Nav_Menu // phpcs:ignore 
{
    /**
  ...
  public function start_el(&$output, $item, $depth = 0, $args = null, $id = 0) //phpcs:ignore
  {
    ...
    if (in_array('current-menu-item', $classes, true) || in_array('current-menu-parent', $classes, true)) {
        ...
        $classes[] = 'brandpaka-menu-item menu-item-' . $item->ID;
        $classes[] = 'nav-item';
  ...
  public static function fallback($args)
  {
      ...
      if (is_string($args['container']) && in_array($args['container'], $allowed_tags, true)) {
        ...
        $fallback_output .= '<' . $args['container'] . $id . $class . '>';
            ...
            // The fallback menu.
                ...
                $fallback_output .= '<li class="nav-item"><a href="' . esc_url(admin_url('nav-menus.php')) . '" class="nav-link" title="' . esc_attr__('Add a menu', 'brandpaka') . '">' . esc_html__('Add a menu', 'brandpaka') . '</a></li>';
                $fallback_output .= '</ul>';
    ...
    if (array_key_exists('echo', $args) && $args['echo']) {
         ...
         */
  public function add_schema_to_navbar_ul($args) //phpcs:ignore
  {
    ...
    if (strpos($wrap, 'SiteNavigationElement') === false) {
      ...
      return $args;
         ...
         */
  private function separate_linkmods_from_classes($classes, &$linkmod_classes, $depth) //phpcs:ignore
  {
     ...
     */
      ...
      return $classes;
         ...
         */
  private function get_linkmod_type($linkmod_classes = []) //phpcs:ignore
  {
      $linkmod_type = '';
    ...
    if (! empty($linkmod_classes)) {
      ...
      return $linkmod_type;
         ...
         */
  private function update_atts_for_linkmod_type($atts = [], $linkmod_classes = []) //phpcs:ignore
  {
    if (! empty($linkmod_classes)) {
      foreach ($linkmod_classes as $link_class) {
        if (! empty($link_class)) {
      ...
      return $atts;
         ...
         */
  private function wrap_for_screen_reader($text = '') //phpcs:ignore
  {
    if ($text) {
      ...
      return $text;
         ...
         */
  private function linkmod_element_open($linkmod_type, $attributes = '') //phpcs:ignore
  {
      $output = '';
    if ('dropdown-item-text' === $linkmod_type) {
         ...
         */
  private function linkmod_element_close($linkmod_type) //phpcs:ignore
  {
      $output = '';
